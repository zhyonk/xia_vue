 ...
 */
!(function (e, t) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = t() : typeof define === 'function' && define.amd ? define(t) : e.Swiper = t()
}(this, function () {
    'use strict'
    var e = function (e) { 
        ...
        if (t) {
            if (typeof t === 'string') {
                ...
                if (o.indexOf('<') >= 0 && o.indexOf('>') >= 0) {
                    var l = 'div'
                    for (o.indexOf('<li') === 0 && (l = 'ul'), o.indexOf('<tr') === 0 && (l = 'tbody'), o.indexOf('<td') !== 0 && o.indexOf('<th') !== 0 || (l = 'tr'), o.indexOf('<tbody') === 0 && (l = 'table'), o.indexOf('<option') === 0 && (l = 'select'), (n = document.createElement(l)).innerHTML = o, a = 0; a < n.childNodes.length; a += 1) s.push(n.childNodes[a])
    ...
    var s = {
        ...
        attr: function (e, t) {
            ...
            for (var s = 0; s < this.length; s += 1) if (i.length === 2) this[s].setAttribute(e, t); else for (var a in e) this[s][a] = e[a], this[s].setAttribute(a, e[a])
            return this
        },
        ...
        on: function () {
            ...
            typeof e[1] === 'function' && (a = (s = e)[0], n = s[1], o = s[2], r = void 0), o || (o = !1)
        ...
        off: function () {
            ...
            typeof e[1] === 'function' && (s = (i = e)[0], r = i[1], n = i[2], a = void 0), n || (n = !1)
        ...
        parent: function (e) {
            for (var s = [], a = 0; a < this.length; a += 1) this[a].parentNode !== null && (e ? t(this[a].parentNode).is(e) && s.push(this[a].parentNode) : s.push(this[a].parentNode))
            return t(i(s))
        },
        parents: function (e) {
        ...
        children: function (s) {
            for (var a = [], r = 0; r < this.length; r += 1) for (var n = this[r].childNodes, o = 0; o < n.length; o += 1) s ? n[o].nodeType === 1 && t(n[o]).is(s) && a.push(n[o]) : n[o].nodeType === 1 && a.push(n[o])
            return new e(i(a))
        },
        remove: function () {
    ...
    var a, r, n, o = typeof window === 'undefined' ? {
        navigator: { userAgent: '' },
        location: {},
        history: {},
    ...
    p.prototype.on = function (e, t) {
        var i = this
        return typeof t !== 'function' ? i : (e.split(' ').forEach(function (e) {
        ...
        for (var e = [], t = arguments.length; t--;) e[t] = arguments[t]
        var i, s, a, r = this
        return r.eventsListeners ? (typeof e[0] === 'string' || Array.isArray(e[0]) ? (i = e[0], s = e.slice(1, e.length), a = r) : (i = e[0].events, s = e[0].data, a = e[0].context || r), (Array.isArray(i) ? i : i.split(' ')).forEach(function (e) {
    ...
    var u = {
        ...
        updateSlides: function () {
            ...
            typeof c === 'function' && (c = e.slidesOffsetBefore.call(this))
            var u = e.slidesOffsetAfter
            typeof u === 'function' && (u = e.slidesOffsetAfter.call(this))
            var f = n, v = this.snapGrid.length, m = this.snapGrid.length, g = e.spaceBetween, b = -c, w = 0, y = 0
            if (void 0 !== i) {
                var x, T
                typeof g === 'string' && g.indexOf('%') >= 0 && (g = parseFloat(g.replace('%', '')) / 100 * i), this.virtualSize = -g, s ? r.css({
                    marginLeft: '',
                    marginTop: ''
                }) : r.css({
                    marginRight: '',
                    marginBottom: ''
                }), e.slidesPerColumn > 1 && (x = Math.floor(n / e.slidesPerColumn) === n / this.params.slidesPerColumn ? n : Math.ceil(n / e.slidesPerColumn) * e.slidesPerColumn, e.slidesPerView !== 'auto' && e.slidesPerColumnFill === 'row' && (x = Math.max(x, e.slidesPerView * e.slidesPerColumn)))
                for (var E, S = e.slidesPerColumn, C = x / S, M = C - (e.slidesPerColumn * C - n), z = 0; z < n; z += 1) {
                    T = 0
                    var P = r.eq(z)
                    if (e.slidesPerColumn > 1) {
                        var k = void 0, $ = void 0, L = void 0
                        e.slidesPerColumnFill === 'column' ? (L = z - ($ = Math.floor(z / S)) * S, ($ > M || $ === M && L === S - 1) && (L += 1) >= S && (L = 0, $ += 1), k = $ + L * x / S, P.css({
                            '-webkit-box-ordinal-group': k,
                            '-moz-box-ordinal-group': k,
                            '-ms-flex-order': k,
                            '-webkit-order': k,
                            order: k
                        })) : $ = z - (L = Math.floor(z / C)) * C, P.css('margin-' + (this.isHorizontal() ? 'top' : 'left'), L !== 0 && e.spaceBetween && e.spaceBetween + 'px').attr('data-swiper-column', $).attr('data-swiper-row', L)
                    }
                    P.css('display') !== 'none' && (e.slidesPerView === 'auto' ? (T = this.isHorizontal() ? P.outerWidth(!0) : P.outerHeight(!0), e.roundLengths && (T = Math.floor(T))) : (T = (i - (e.slidesPerView - 1) * g) / e.slidesPerView, e.roundLengths && (T = Math.floor(T)), r[z] && (this.isHorizontal() ? r[z].style.width = T + 'px' : r[z].style.height = T + 'px')), r[z] && (r[z].swiperSlideSize = T), p.push(T), e.centeredSlides ? (b = b + T / 2 + w / 2 + g, w === 0 && z !== 0 && (b = b - i / 2 - g), z === 0 && (b = b - i / 2 - g), Math.abs(b) < 0.001 && (b = 0), y % e.slidesPerGroup == 0 && o.push(b), d.push(b)) : (y % e.slidesPerGroup == 0 && o.push(b), d.push(b), b = b + T + g), this.virtualSize += T + g, w = T, y += 1)
                }
                if (this.virtualSize = Math.max(this.virtualSize, i) + u, s && a && (e.effect === 'slide' || e.effect === 'coverflow') && t.css({ width: this.virtualSize + e.spaceBetween + 'px' }), h.flexbox && !e.setWrapperSize || (this.isHorizontal() ? t.css({ width: this.virtualSize + e.spaceBetween + 'px' }) : t.css({ height: this.virtualSize + e.spaceBetween + 'px' })), e.slidesPerColumn > 1 && (this.virtualSize = (T + e.spaceBetween) * x, this.virtualSize = Math.ceil(this.virtualSize / e.slidesPerColumn) - e.spaceBetween, this.isHorizontal() ? t.css({ width: this.virtualSize + e.spaceBetween + 'px' }) : t.css({ height: this.virtualSize + e.spaceBetween + 'px' }), e.centeredSlides)) {
                    E = []
                ...
                o.length === 0 && (o = [0]), e.spaceBetween !== 0 && (this.isHorizontal() ? s ? r.css({ marginLeft: g + 'px' }) : r.css({ marginRight: g + 'px' }) : r.css({ marginBottom: g + 'px' })), l.extend(this, {
                    slides: r,
                    snapGrid: o,
                    slidesGrid: d,
                    slidesSizesGrid: p
        ...
        updateProgress: function (e) {
            ...
            i === 0 ? (s = 0, a = !0, r = !0) : (a = (s = (e - this.minTranslate()) / i) <= 0, r = s >= 1), l.extend(this, {
                progress: s,
                isBeginning: a,
                isEnd: r
        ...
        setTranslate: function (e, t) {
            ...
            (l === 0 ? 0 : (e - this.minTranslate()) / l) !== r && this.updateProgress(e), this.emit('setTranslate', this.translate, t)
        },
        ...
        slideToClickedSlide: function () {
            var e, i = this, s = i.params, a = i.$wrapperEl,
                r = s.slidesPerView === 'auto' ? i.slidesPerViewDynamic() : s.slidesPerView, n = i.clickedIndex
            if (s.loop) {
        ...
        loopCreate: function () {
            ...
            i.slidesPerView !== 'auto' || i.loopedSlides || (i.loopedSlides = a.length), e.loopedSlides = parseInt(i.loopedSlides || i.slidesPerView, 10), e.loopedSlides += i.loopAdditionalSlides, e.loopedSlides > a.length && (e.loopedSlides = a.length)
            var l = [], h = []
            a.each(function (i, s) {
                var r = t(s)
        ...
        loopFix: function () {
            ...
            this.allowSlidePrev = !0, this.allowSlideNext = !0, i < a ? (e = s.length - 3 * a + i, e += a, this.slideTo(e, 0, !1, !0)) : (t.slidesPerView === 'auto' && i >= 2 * a || i > s.length - 2 * t.slidesPerView) && (e = -s.length + i + a, e += a, this.slideTo(e, 0, !1, !0)), this.allowSlidePrev = r, this.allowSlideNext = n
        },
        ...
        appendSlide: function (e) {
            ...
            if (i.loop && this.loopDestroy(), typeof e === 'object' && 'length' in e) for (var s = 0; s < e.length; s += 1) e[s] && t.append(e[s]); else t.append(e)
        ...
        if (i && (t.os = 'windows', t.osVersion = i[2], t.windows = !0), s && !i && (t.os = 'android', t.osVersion = s[2], t.android = !0, t.androidChrome = e.toLowerCase().indexOf('chrome') >= 0), (a || n || r) && (t.os = 'ios', t.ios = !0), n && !r && (t.osVersion = n[2].replace(/_/g, '.'), t.iphone = !0), a && (t.osVersion = a[2].replace(/_/g, '.'), t.ipad = !0), r && (t.osVersion = r[3] ? r[3].replace(/_/g, '.') : null, t.iphone = !0), t.ios && t.osVersion && e.indexOf('Version/') >= 0 && t.osVersion.split('.')[0] === '10' && (t.osVersion = e.toLowerCase().split('version/')[1].split(' ')[0]), t.desktop = !(t.os || t.android || t.webView), t.webView = (n || a || r) && e.match(/.*AppleWebKit(?!.*Safari)/i), t.os && t.os === 'ios') {
        ...
        if (r.originalEvent && (r = r.originalEvent), i.isTouchEvent = r.type === 'touchstart', (i.isTouchEvent || !('which' in r) || r.which !== 3) && (!i.isTouched || !i.isMoved)) {
            if (s.noSwiping && t(r.target).closest('.' + s.noSwipingClass)[0]) this.allowClick = !0; else if (!s.swipeHandler || t(r).closest(s.swipeHandler)[0]) {
                a.currentX = r.type === 'touchstart' ? r.targetTouches[0].pageX : r.pageX, a.currentY = r.type === 'touchstart' ? r.targetTouches[0].pageY : r.pageY
                ...
                if (!(y.ios && !y.cordova && s.iOSEdgeSwipeDetection && n <= s.iOSEdgeSwipeThreshold && n >= window.screen.width - s.iOSEdgeSwipeThreshold)) {
                    if (l.extend(i, {
                        ...
                        isScrolling: void 0,
                        startMoving: void 0
                    }), a.startX = n, a.startY = o, i.touchStartTime = l.now(), this.allowClick = !0, this.updateSize(), this.swipeDirection = void 0, s.threshold > 0 && (i.allowThresholdMove = !1), r.type !== 'touchstart') {
                        var h = !0
        ...
        if (n.originalEvent && (n = n.originalEvent), !i.isTouchEvent || n.type !== 'mousemove') {
            var o = n.type === 'touchmove' ? n.targetTouches[0].pageX : n.pageX,
                h = n.type === 'touchmove' ? n.targetTouches[0].pageY : n.pageY
            if (n.preventedByNestedSwiper) return a.startX = o, void (a.startY = h)
            if (!this.allowTouchMove) {
                return this.allowClick = !1, void (i.isTouched && (l.extend(a, {
                    startX: o,
                    startY: h,
                    currentX: o,
                    currentY: h
            ...
            if (i.allowTouchCallbacks && this.emit('touchMove', n), !(n.targetTouches && n.targetTouches.length > 1)) {
                ...
                if (i.isScrolling && this.emit('touchMoveOpposite', n), typeof startMoving === 'undefined' && (a.currentX === a.startX && a.currentY === a.startY || (i.startMoving = !0)), i.isTouched) {
                    if (i.isScrolling) i.isTouched = !1; else if (i.startMoving) {
                        ...
                        s.followFinger && ((s.freeMode || s.watchSlidesProgress || s.watchSlidesVisibility) && (this.updateActiveIndex(), this.updateSlidesClasses()), s.freeMode && (i.velocities.length === 0 && i.velocities.push({
        ...
        if (h.originalEvent && (h = h.originalEvent), i.allowTouchCallbacks && t.emit('touchEnd', h), i.allowTouchCallbacks = !1, i.isTouched) {
            ...
            }), !i.isTouched || !i.isMoved || !t.swipeDirection || a.diff === 0 || i.currentTranslate === i.startTranslate) return i.isTouched = !1, void (i.isMoved = !1)
            if (i.isTouched = !1, i.isMoved = !1, p = s.followFinger ? r ? t.translate : -t.translate : -i.currentTranslate, s.freeMode) {
                ...
                if (s.freeModeMomentum) {
                    ...
                    if (y < t.maxTranslate()) s.freeModeMomentumBounce ? (y + t.maxTranslate() < -E && (y = t.maxTranslate() - E), x = t.maxTranslate(), T = !0, i.allowMomentumBounce = !0) : y = t.maxTranslate(); else if (y > t.minTranslate()) s.freeModeMomentumBounce ? (y - t.minTranslate() > E && (y = t.minTranslate() + E), x = t.minTranslate(), T = !0, i.allowMomentumBounce = !0) : y = t.minTranslate(); else if (s.freeModeSticky) {
                        ...
                        y = -(y = Math.abs(d[S] - y) < Math.abs(d[S - 1] - y) || t.swipeDirection === 'next' ? d[S] : d[S - 1])
                    }
                    if (t.velocity !== 0) b = r ? Math.abs((-y - t.translate) / t.velocity) : Math.abs((y - t.translate) / t.velocity); else if (s.freeModeSticky) return void t.slideReset()
                ...
                if (u > s.longSwipesMs) {
                    ...
                    t.swipeDirection === 'next' && (k >= s.longSwipesRatio ? t.slideTo(M + s.slidesPerGroup) : t.slideTo(M)), t.swipeDirection === 'prev' && (k > 1 - s.longSwipesRatio ? t.slideTo(M + s.slidesPerGroup) : t.slideTo(M))
                } else {
                    if (!s.shortSwipes) return void t.slideTo(t.activeIndex)
                    t.swipeDirection === 'next' && t.slideTo(M + s.slidesPerGroup), t.swipeDirection === 'prev' && t.slideTo(M)
                }
            }
        }
    }, S = function () {
        ...
        if (!t || t.offsetWidth !== 0) {
            ...
            } else this.updateSlidesClasses(), (e.slidesPerView === 'auto' || e.slidesPerView > 1) && this.isEnd && !this.params.centeredSlides ? this.slideTo(this.slides.length - 1, 0, !1, !0) : this.slideTo(this.activeIndex, 0, !1, !0)
    ...
    var M = {
        ...
        events: {
            attachEvents: function () {
                ...
                var a = e.touchEventsTarget === 'container' ? i : s, r = !!e.nested
                if (h.pointerEvents || h.prefixedPointerEvents) a.addEventListener(t.start, this.onTouchStart, !1), (h.touch ? a : d).addEventListener(t.move, this.onTouchMove, r), (h.touch ? a : d).addEventListener(t.end, this.onTouchEnd, !1); else {
                    if (h.touch) {
                        var n = !(t.start !== 'touchstart' || !h.passiveListener || !e.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        }
            ...
            detachEvents: function () {
                var e = this.params, t = this.touchEvents, i = this.el, s = this.wrapperEl,
                    a = e.touchEventsTarget === 'container' ? i : s, r = !!e.nested
                if (h.pointerEvents || h.prefixedPointerEvents) a.removeEventListener(t.start, this.onTouchStart, !1), (h.touch ? a : d).removeEventListener(t.move, this.onTouchMove, r), (h.touch ? a : d).removeEventListener(t.end, this.onTouchEnd, !1); else {
                    if (h.touch) {
                        var n = !(t.start !== 'onTouchStart' || !h.passiveListener || !e.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        }
        ...
        checkOverflow: {
            checkOverflow: function () {
                var e = this.isLocked
                this.isLocked = this.snapGrid.length === 1, this.allowTouchMove = !this.isLocked, e && e !== this.isLocked && (this.isEnd = !1, this.navigation.update())
            }
        },
        classes: {
            addClasses: function () {
        ...
        images: {
            ...
            preloadImages: function () {
                ...
                function t() {
                    void 0 !== e && e !== null && e && !e.destroyed && (void 0 !== e.imagesLoaded && (e.imagesLoaded += 1), e.imagesLoaded === e.imagesToLoad.length && (e.params.updateOnImagesReady && e.update(), e.emit('imagesReady')))
                }
        ...
        function i() {
            ...
            n.length === 1 && n[0].constructor && n[0].constructor === Object ? a = n[0] : (s = (r = n)[0], a = r[1])
            ...
            void 0 === d.modules && (d.modules = {}), Object.keys(d.modules).forEach(function (e) {
                ...
                if (t.params) {
                    ...
                    !0 === a[i] && (a[i] = { enabled: !0 }), typeof a[i] !== 'object' || 'enabled' in a[i] || (a[i].enabled = !0), a[i] || (a[i] = { enabled: !1 })
                }
            })
            var p = l.extend({}, M)
            ...
            if (s = c[0]) {
                ...
                return l.extend(d, {
                    ...
                    rtl: d.params.direction === 'horizontal' && (s.dir.toLowerCase() === 'rtl' || c.css('direction') === 'rtl'),
                    wrongRTL: m.css('display') === '-webkit-box',
                    activeIndex: 0,
                    realIndex: 0,
                    isBeginning: !0,
                    isEnd: !1,
        ...
        return i.prototype.slidesPerViewDynamic = function () {
            ...
            var e = this
            e && !e.destroyed && (e.updateSize(), e.updateSlides(), e.updateProgress(), e.updateSlidesClasses(), e.params.freeMode ? (t(), e.params.autoHeight && e.updateAutoHeight()) : ((e.params.slidesPerView === 'auto' || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0)) || t(), e.emit('update'))
        ...
        L = { name: 'support', proto: { support: h }, static: { support: h } }, I = (function () {
            ...
            handle: function (e) {
                ...
                if (!this.allowSlideNext && (this.isHorizontal() && i === 39 || this.isVertical() && i === 40)) return !1
                if (!this.allowSlidePrev && (this.isHorizontal() && i === 37 || this.isVertical() && i === 38)) return !1
                if (!(t.shiftKey || t.altKey || t.ctrlKey || t.metaKey || d.activeElement && d.activeElement.nodeName && (d.activeElement.nodeName.toLowerCase() === 'input' || d.activeElement.nodeName.toLowerCase() === 'textarea'))) {
                    if (this.params.keyboard.onlyInViewport && (i === 37 || i === 39 || i === 38 || i === 40)) {
                        var s = !1
                    ...
                    this.isHorizontal() ? (i !== 37 && i !== 39 || (t.preventDefault ? t.preventDefault() : t.returnValue = !1), (i === 39 && !this.rtl || i === 37 && this.rtl) && this.slideNext(), (i === 37 && !this.rtl || i === 39 && this.rtl) && this.slidePrev()) : (i !== 38 && i !== 40 || (t.preventDefault ? t.preventDefault() : t.returnValue = !1), i === 40 && this.slideNext(), i === 38 && this.slidePrev()), this.emit('keyPress', i)
                }
            },
            enable: function () {
    ...
    var B = {
        ...
        normalize: function (e) {
            var t = 0, i = 0, s = 0, a = 0
            return 'detail' in e && (i = e.detail), 'wheelDelta' in e && (i = -e.wheelDelta / 120), 'wheelDeltaY' in e && (i = -e.wheelDeltaY / 120), 'wheelDeltaX' in e && (t = -e.wheelDeltaX / 120), 'axis' in e && e.axis === e.HORIZONTAL_AXIS && (t = i, i = 0), s = 10 * t, a = 10 * i, 'deltaY' in e && (a = e.deltaY), 'deltaX' in e && (s = e.deltaX), (s || a) && e.deltaMode && (e.deltaMode === 1 ? (s *= 40, a *= 40) : (s *= 800, a *= 800)), s && !t && (t = s < 1 ? -1 : 1), a && !i && (i = a < 1 ? -1 : 1), {
                spinX: t,
                spinY: i,
                pixelX: s,
                pixelY: a
        ...
        handle: function (e) {
            ...
            if (s.invert && (a = -a), i.params.freeMode) {
                ...
                if (d >= i.minTranslate() && (d = i.minTranslate()), d <= i.maxTranslate() && (d = i.maxTranslate()), i.setTransition(0), i.setTranslate(d), i.updateProgress(), i.updateActiveIndex(), i.updateSlidesClasses(), (!h && i.isBeginning || !p && i.isEnd) && i.updateSlidesClasses(), i.params.freeModeSticky && (clearTimeout(i.mousewheel.timeout), i.mousewheel.timeout = l.nextTick(function () {
                    i.slideReset()
                }, 300)), i.emit('scroll', t), i.params.autoplay && i.params.autoplayDisableOnInteraction && i.stopAutoplay(), d === 0 || d === i.maxTranslate()) return !0
            } else {
        ...
        enable: function () {
            ...
            var e = this.$el
            return this.params.mousewheel.eventsTarged !== 'container' && (e = t(this.params.mousewheel.eventsTarged)), e.on(B.event, this.mousewheel.handle), this.mousewheel.enabled = !0, !0
        },
        disable: function () {
            if (!B.event) return !1
            if (!this.mousewheel.enabled) return !1
            var e = this.$el
            return this.params.mousewheel.eventsTarged !== 'container' && (e = t(this.params.mousewheel.eventsTarged)), e.off(B.event, this.mousewheel.handle), this.mousewheel.enabled = !1, !0
        }
    }, V = {
        update: function () {
        ...
        update: function () {
            ...
            if (i.el && this.pagination.el && this.pagination.$el && this.pagination.$el.length !== 0) {
                var s,
                    a = this.virtual && this.params.virtual.enabled ? this.virtual.slides.length : this.slides.length,
                    r = this.pagination.$el,
                    n = this.params.loop ? Math.ceil((a - 2 * this.loopedSlides) / this.params.slidesPerGroup) : this.snapGrid.length
                if (this.params.loop ? ((s = Math.ceil((this.activeIndex - this.loopedSlides) / this.params.slidesPerGroup)) > a - 1 - 2 * this.loopedSlides && (s -= a - 2 * this.loopedSlides), s > n - 1 && (s -= n), s < 0 && this.params.paginationType !== 'bullets' && (s = n + s)) : s = void 0 !== this.snapIndex ? this.snapIndex : this.activeIndex || 0, i.type === 'bullets' && this.pagination.bullets && this.pagination.bullets.length > 0) {
                ...
                if (i.type === 'fraction' && (r.find('.' + i.currentClass).text(s + 1), r.find('.' + i.totalClass).text(n)), i.type === 'progressbar') {
                    var c = (s + 1) / n, u = c, f = 1
                ...
                i.type === 'custom' && i.renderCustom ? (r.html(i.renderCustom(this, s + 1, n)), this.emit('paginationRender', this, r[0])) : this.emit('paginationUpdate', this, r[0]), r[this.params.watchOverflow && this.isLocked ? 'addClass' : 'removeClass'](i.lockClass)
            }
        },
        render: function () {
        ...
        updateSize: function () {
            if (this.params.scrollbar.el && this.scrollbar.el) {
                ...
                var s, a = this.isHorizontal() ? i[0].offsetWidth : i[0].offsetHeight, r = this.size / this.virtualSize,
                    n = r * (a / this.size)
                s = this.params.scrollbar.dragSize === 'auto' ? a * r : parseInt(this.params.scrollbar.dragSize, 10), this.isHorizontal() ? t[0].style.width = s + 'px' : t[0].style.height = s + 'px', i[0].style.display = r >= 1 ? 'none' : '', this.params.scrollbarHide && (i[0].style.opacity = 0), l.extend(e, {
                    trackSize: a,
                    divider: r,
                    moveDivider: n,
                    dragSize: s
        ...
        setDragPosition: function (e) {
            ...
            t = ((this.isHorizontal() ? e.type === 'touchstart' || e.type === 'touchmove' ? e.targetTouches[0].pageX : e.pageX || e.clientX : e.type === 'touchstart' || e.type === 'touchmove' ? e.targetTouches[0].pageY : e.pageY || e.clientY) - s.offset()[this.isHorizontal() ? 'left' : 'top'] - a / 2) / (r - a), t = Math.max(Math.min(t, 1), 0), this.rtl && (t = 1 - t)
        ...
        init: function () {
            ...
            if (e.params.scrollbar.el) {
                ...
                e.params.uniqueNavElements && typeof r.el === 'string' && n.length > 1 && s.find(r.el).length === 1 && (n = s.find(r.el))
                var o = n.find('.swiper-scrollbar-drag')
                o.length === 0 && (o = t('<div class="swiper-scrollbar-drag"></div>'), n.append(o)), e.scrollbar.dragEvents = !1 !== e.params.simulateTouch || h.touch ? a : {
                    start: 'mousedown',
                    move: 'mousemove',
                    end: 'mouseup'
        ...
        setTransform: function (e, i) {
            ...
            if (o || l ? (o = o || '0', l = l || '0') : this.isHorizontal() ? (o = n, l = '0') : (l = n, o = '0'), o = o.indexOf('%') >= 0 ? parseInt(o, 10) * i * r + '%' : o * i * r + 'px', l = l.indexOf('%') >= 0 ? parseInt(l, 10) * i + '%' : l * i + 'px', void 0 !== h && h !== null) {
                var p = h - (h - 1) * (1 - Math.abs(i))
                a[0].style.opacity = p
            }
            if (void 0 === d || d === null) a.transform('translate3d(' + o + ', ' + l + ', 0px)'); else {
        ...
        setTranslate: function () {
            ...
            i.children('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each(function (t, i) {
                ...
                var n = s.progress
                e.params.slidesPerGroup > 1 && e.params.slidesPerView !== 'auto' && (n += Math.ceil(i / 2) - a * (r.length - 1)), n = Math.min(Math.max(n, -1), 1), t(s).find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each(function (t, i) {
        ...
        onGestureStart: function (e) {
            ...
            a.$slideEl && a.$slideEl.length || (a.$slideEl = t(this), a.$slideEl.length === 0 && (a.$slideEl = this.slides.eq(this.activeIndex)), a.$imageEl = a.$slideEl.find('img, svg, canvas'), a.$imageWrapEl = a.$imageEl.parent('.' + i.containerClass), a.maxRatio = a.$imageWrapEl.attr('data-swiper-zoom') || i.maxRatio, a.$imageWrapEl.length !== 0) ? (a.$imageEl.transition(0), this.zoom.isScaling = !0) : a.$imageEl = void 0
        },
        ...
        onTouchStart: function (e) {
            ...
            i.$imageEl && i.$imageEl.length !== 0 && (s.isTouched || (y.android && e.preventDefault(), s.isTouched = !0, s.touchesStart.x = e.type === 'touchstart' ? e.targetTouches[0].pageX : e.pageX, s.touchesStart.y = e.type === 'touchstart' ? e.targetTouches[0].pageY : e.pageY))
        },
        ...
        enable: function () {
            ...
            if (!i.enabled) {
                i.enabled = !0
                var s = e.slides,
                    a = !(e.touchEvents.start !== 'touchstart' || !h.passiveListener || !e.params.passiveListeners) && {
                        passive: !0,
                        capture: !1
                    }
            ...
            if (void 0 !== e && s.slides.length !== 0) {
                ...
                !r.hasClass(a.elementClass) || r.hasClass(a.loadedClass) || r.hasClass(a.loadingClass) || (n = n.add(r[0])), n.length !== 0 && n.each(function (e, n) {
                    ...
                    s.loadImage(o[0], d || l, h, p, !1, function () {
                        if (void 0 !== s && s !== null && s && (!s || s.params) && !s.destroyed) {
        ...
        setTranslate: function (e, t) {
            ...
            function n(e) {
                var t = e.rtl && e.params.direction === 'horizontal' ? -a.translate : a.translate
        ...
        setTransition: function (e, t) {
            ...
            function r(t) {
                t.setTransition(e, s), e !== 0 && (t.transitionStart(), t.$wrapperEl.transitionEnd(function () {
        ...
        setHash: function () {
            if (this.hashNavigation.initialized && this.params.hashNavigation.enabled) {
                if (this.params.hashNavigation.replaceState && o.history && o.history.replaceState) o.history.replaceState(null, null, '#' + this.slides.eq(this.activeIndex).attr('data-hash') || ''); else {
        ...
        pause: function (e) {
            var t = this
            t.autoplay.running && (t.autoplay.paused || (t.autoplay.timeout && clearTimeout(t.autoplay.timeout), t.autoplay.paused = !0, e !== 0 && t.params.autoplay.waitForTransition ? t.$wrapperEl.transitionEnd(function () {
        ...
        setTranslate: function () {
            ...
            d.shadow && (h ? ((e = s.find('.swiper-cube-shadow')).length === 0 && (e = t('<div class="swiper-cube-shadow"></div>'), s.append(e)), e.css({ height: r + 'px' })) : (e = i.find('.swiper-cube-shadow')).length === 0 && (e = t('<div class="swiper-cube-shadow"></div>'), i.append(e)))
            for (var u = 0; u < a.length; u += 1) {
                ...
                if (b <= 1 && b > -1 && (c = 90 * v + 90 * b, o && (c = 90 * -v - 90 * b)), f.transform(T), d.slideShadows) {
                    ...
                    E.length === 0 && (E = t('<div class="swiper-slide-shadow-' + (h ? 'left' : 'top') + '"></div>'), f.append(E)), S.length === 0 && (S = t('<div class="swiper-slide-shadow-' + (h ? 'right' : 'bottom') + '"></div>'), f.append(S)), E.length && (E[0].style.opacity = Math.max(-b, 0)), S.length && (S[0].style.opacity = Math.max(b, 0))
                }
            }
            if (s.css({
        ...
        setTranslate: function () {
            for (var e = this.slides, i = 0; i < e.length; i += 1) {
                ...
                if (this.isHorizontal() ? this.rtl && (r = -r) : (l = o, o = 0, n = -r, r = 0), s[0].style.zIndex = -Math.abs(Math.round(a)) + e.length, this.params.flipEffect.slideShadows) {
                    ...
                    d.length === 0 && (d = t('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'left' : 'top') + '"></div>'), s.append(d)), h.length === 0 && (h = t('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? 'right' : 'bottom') + '"></div>'), s.append(h)), d.length && (d[0].style.opacity = Math.max(-a, 0)), h.length && (h[0].style.opacity = Math.max(a, 0))
                }
        ...
        setTranslate: function () {
            for (var e = this.width, i = this.height, s = this.slides, a = this.$wrapperEl, r = this.slidesSizesGrid, n = this.params.coverflowEffect, o = this.isHorizontal(), l = this.translate, d = o ? e / 2 - l : i / 2 - l, p = o ? n.rotate : -n.rotate, c = n.depth, u = 0, f = s.length; u < f; u += 1) {
                ...
                if (v.transform(E), v[0].style.zIndex = 1 - Math.abs(Math.round(g)), n.slideShadows) {
                    ...
                    S.length === 0 && (S = t('<div class="swiper-slide-shadow-' + (o ? 'left' : 'top') + '"></div>'), v.append(S)), C.length === 0 && (C = t('<div class="swiper-slide-shadow-' + (o ? 'right' : 'bottom') + '"></div>'), v.append(C)), S.length && (S[0].style.opacity = g > 0 ? g : 0), C.length && (C[0].style.opacity = -g > 0 ? -g : 0)
                }
            }
